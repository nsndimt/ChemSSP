# -*- coding: utf-8 -*-
"""
Taken from https://github.com/CambridgeMolecularEngineering/chemdataextractor2/blob/df508f68712fd97ce3f64b8e9e41b79a95db54e2/chemdataextractor/nlp/tokenize.py
Great thanks to Original chemdataextractor2 author
Install the whole CDE makes conda environment incompatible
"""
...
class SentenceTokenizer(BaseTokenizer):
    ...
    def __init__(self, model=None):
        ...
        self._tokenizer = pickle.load(open(os.path.join(os.path.dirname(__file__), os.path.join(self.model)), 'rb'))
